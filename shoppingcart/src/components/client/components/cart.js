...
function Cart() {
    ...
    const confirmButton = () => {
        return loading ?
              ...
              <Button variant="contained" className='add-to-cart' onClick={() => { confirmSale() }}>
                Confirm
              </Button>
    }
    return (
    ...
    <Grid container spacing={1} className={cartStyle.grid}>
      <Grid item xs={12} md={8} justifyContent='center'>
        <div className={cartStyle.title}>
          <Typography variant="span" ml={2} color={'#EE4D2D'} fontSize={40} component="h2" fontWeight={500}>
            Cart
          </Typography>
        </div>
      ...
      <Grid item xs={12} md={3} justifyContent='center'>
        <div className={cartStyle.prev_container}>
          <Typography variant="span" color={'#113366'} fontSize={30} component="h2" fontWeight={500}>
          Previous Orders
          </Typography>
          {salesList.map(sale =>
            <div className={cartStyle.prev_sales} key={sale.total}>
              ...
              <Typography mt={2} variant="span" fontSize={15} component="h2" fontWeight={600}>

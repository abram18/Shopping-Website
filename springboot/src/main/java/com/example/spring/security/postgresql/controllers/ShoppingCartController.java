...
import com.example.spring.security.postgresql.services.ShoppingCartService;
...
public class ShoppingCartController {
    ...
    public ResponseEntity<Message> addProduct(@RequestBody ShoppingCart shoppingCart,
        ...
        if (bindingResult.hasErrors())
            return new ResponseEntity<>(new Message("Please review the fields"),HttpStatus.BAD_REQUEST);
